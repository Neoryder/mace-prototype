...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'net.incuventure.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'net.incuventure.UserRole'
grails.plugin.springsecurity.authority.className = 'net.incuventure.Role'
