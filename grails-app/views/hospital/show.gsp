...
<html>
	...
	<body>
		...
		<div id="show-hospital" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:hospitalInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${hospitalInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
