...
<html>
	...
	<body>
		<a href="#create-approval" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-approval" class="content scaffold-create" role="main">
